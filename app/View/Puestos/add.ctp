...
<div class ="container">
	<div class = "row">
			<div class="col-md-6">
				<?php echo $this->Form->create('Puesto', array('role' => 'form' )); ?><p>

				<fieldset>
					<h2><?php echo __('Registrar Puesto'); ?></h2>
				<?php
			...
			<p>
				<?php echo $this->Form->end(array('label' => 'Registrar Puesto', 'class' =>'btn btn-success')); ?>
				</p>
