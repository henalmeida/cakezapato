<div class ="container">
	<div class = "row">
			<div class="col-md-6">
				<?php echo $this->Form->create('Zapato', array('role' => 'form' )); ?><p>

				<fieldset>
					<h2><?php echo __('Registrar Zapato'); ?></h2>
				<?php
			...
			<p>
				<?php echo $this->Form->end(array('label' => 'Registrar Zapato', 'class' =>'btn btn-success')); ?>
				</p>
